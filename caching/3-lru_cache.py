...
class LRUCache(BaseCaching):
    """
    LRUCache is a caching system that uses the Least Recently Used (LRU) algorithm
    to manage cache eviction. When the cache exceeds MAX_ITEMS, the least recently
